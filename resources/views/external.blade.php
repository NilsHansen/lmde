                    ...
                    <div class="row h-100">
                        <div class="col-6 col-md-8 my-auto">
                            <ul class="list-inline mb-0" id="menu">
                                ...
                                <li class="list-inline-item d-print-none"><a href="javascript:window.print()" class="text-reset text-decoration-none"><i class="fas fa-print"></i> <span class="d-none d-md-inline-block">@lang('Print')</span></a></li>
                            </ul>
                        </div>
